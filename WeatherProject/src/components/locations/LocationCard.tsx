                ...
                <View style={styles.weatherContent}>
                  ...
                  <View style={styles.weatherDetails}>
                    ...
                    <View style={styles.temperatureRow}>
                      <Text style={styles.temperature}>{formatTemperature(location.weather.temperature)}</Text>
                      {location.weather.temperature_max !== undefined &&
                        location.weather.temperature_min !== undefined && (
                          <Text style={styles.tempRange}>
                            {formatTemperature(location.weather.temperature_min)} -{" "}
                            {formatTemperature(location.weather.temperature_max)}
                          </Text>
                        )}
                    </View>
                  </View>
