            ...
            {loadingWeather ? (
              ...
              <View style={styles.errorContainer}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => fetchWeatherData(currentLocation.latitude, currentLocation.longitude)}
                >
                    ...
                    <View style={styles.dayDetailsContainer}>
                      ...
                      <View style={styles.dayDetailsContent}>
                        ...
                        <View style={styles.dayDetailItem}>
                          ...
                          <Text style={styles.dayDetailValue}>
                            {weatherData.daily.precipitation_sum[selectedDay]} mm
                          </Text>
                        </View>
                        <View style={styles.dayDetailItem}>
                  ...
                  <View style={styles.authContainer}>
                    {isSignedIn ? (
                      <>
                        ...
                        <TouchableOpacity style={styles.myLocationsButton} onPress={() => router.push("/locations")}>
