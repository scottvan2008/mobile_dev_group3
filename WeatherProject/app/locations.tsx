...
export default function Locations() {
  ...
  const { isSignedIn, userId, isProcessingAction, setIsProcessingAction } = useAuth();
  ...
  const { savedLocations, loadingLocations, refreshing, fetchSavedLocations, handleRefresh } =
  ...
  // Delete a saved location and refresh the list
  ...
  // Navigate to view weather for a selected location
  ...
  // Render empty state when no saved locations exist
  ...
  // Interpolate the map panel height
