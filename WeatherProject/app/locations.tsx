...
export default function Locations() {
  ...
  const { isSignedIn, userId, isProcessingAction, setIsProcessingAction, handleSignOut } = useAuth()
  ...
  const { savedLocations, loadingLocations, refreshing, fetchSavedLocations, handleRefresh } = useSavedLocations(userId)
          ...
          <LinearGradient colors={[...gradientColors]} style={styles.gradientBackground}>
            ...
            <View style={styles.content}>
              <View style={styles.sectionHeader}>
                ...
                <TouchableOpacity style={styles.addCurrentButton} onPress={getCurrentLocation}>
                  <Icon name="crosshairs-gps" size={18} color="white" />
                  <Text style={styles.addButtonText}>Add Current</Text>
                </TouchableOpacity>
              </View>
              ...
              {loadingLocations ? (
                ...
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <LocationCard location={item} viewWeather={viewWeather} deleteLocation={handleDeleteLocation} />
                  )}
