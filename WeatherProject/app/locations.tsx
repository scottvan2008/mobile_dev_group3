...
export default function Locations() {
  ...
  const renderLocationItem = ({ item }: { item: SavedLocation }) => {
    ...
    return (
      <TouchableOpacity onPress={() => viewWeather(item)} style={styles.locationCard}>
            ...
            {item.isLoadingWeather ? (
              ...
              <>
                <View style={styles.weatherIconContainer}>
                  <Icon name={info?.icon || "weather-cloudy"} size={28} color="#4FC3F7" />
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.container}>
        <LinearGradient colors={["#87CEEB", "#48D1CC"]} style={styles.gradientBackground}>
