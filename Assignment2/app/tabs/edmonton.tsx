        ...
        <ThemedView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <ThemedText type="default" style={styles.listItem}>
                    Edmonton is the capital city of Alberta, Canada. It is known
                ...
                <ThemedText type="default" style={styles.listItem}>
                    Edmonton experiences a humid continental climate with cold
                    winters and warm summers. The city enjoys long daylight
                    hours during the summer, while winters can be snowy with
                    temperatures often dropping below freezing.
                </ThemedText>
                ...
                <ThemedText type="default" style={styles.listItem}>
                    Edmonton is a key economic hub in Alberta, with strong
                    industries in oil and gas, technology, healthcare, and
                    education. The city has a growing tech sector, supported by
                    a vibrant entrepreneurial ecosystem and major research
                    institutions like the University of Alberta.
                </ThemedText>
